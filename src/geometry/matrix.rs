...
impl Matrix {
    ...
    pub fn mul_f(&self, s : &f64) -> Matrix {
...
impl Div<f64, Matrix> for Matrix {
...
impl Add<Matrix, Matrix> for Matrix {
    fn add(&self, o : &Matrix) -> Matrix {
        Matrix::new([self[ 0] + o.m[ 0], self[ 1] + o.m[ 1], self[ 2] + o.m[ 2], self[ 3] + o.m[ 3],
                     self[ 4] + o.m[ 4], self[ 5] + o.m[ 5], self[ 6] + o.m[ 6], self[ 7] + o.m[ 7],
                     self[ 8] + o.m[ 8], self[ 9] + o.m[ 9], self[10] + o.m[10], self[11] + o.m[11],
                     self[12] + o.m[12], self[13] + o.m[13], self[14] + o.m[14], self[15] + o.m[15]])
    }
}
