...
fn main() {
    ...
    scene.add(Arc::new(Cone::unit().rotate(-FRAC_PI_2, &Vector::unit_x()).translate(&Vector::new(4f32, 0.8f32, 6f32))));
    scene.add(Arc::new(Cone::new_partial(0.5f32, 1f32, 0.0f32, 1.0f32, PI).rotate(FRAC_PI_2, &Vector::unit_y()).translate(&Vector::new(4f32, -0.8f32, 6f32))));
    // scene.add(Arc::new(Cone::new_partial(0.5f32, 1f32, 0.0f32, 1.0f32, PI).translate(&Vector::new(4f32, -0.8f32, 6f32))));
